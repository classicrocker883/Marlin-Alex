...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_CREALITY_V427  // Creality Board v4.2.2
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45.0, -6.2, -1.75 }
...
#define Z_MIN_POS 0
#define X_MAX_POS 220 + 10 // Extended max to allow the probe to reach more of the bed.
