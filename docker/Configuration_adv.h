...
#if ANY(IS_ULTIPANEL, EXTENSIBLE_UI, DWIN_CREALITY_LCD) //_LCD_JYERSUI)
...
#if EITHER(SDSUPPORT, LCD_SET_PROGRESS_MANUALLY) && ANY(HAS_MARLINUI_U8GLIB, HAS_MARLINUI_HD44780, IS_TFTGLCD_PANEL, EXTENSIBLE_UI, DWIN_CREALITY_LCD) //_JYERSUI
 ...
 */
  ...
  //#define PROBING_MARGIN_LEFT PROBING_MARGIN - 8
  //#define PROBING_MARGIN_RIGHT PROBING_MARGIN + 4
  //#define PROBING_MARGIN_FRONT PROBING_MARGIN + 3
  //#define PROBING_MARGIN_BACK PROBING_MARGIN - 3
#endif
...
#define ARC_SUPPORT                   // Requires ~3226 bytes
  ...
  #define MIN_ARC_SEGMENT_MM      0.1 //#define MM_PER_ARC_SEGMENT     0.1  // (mm) Minimum length of each arc segment
  #define MAX_ARC_SEGMENT_MM      1.0 //#define ARC_SEGMENTS_PER_R     1.0  // (mm) Maximum length of each arc segment
  #define MIN_CIRCLE_SEGMENTS    24   //#define MIN_ARC_SEGMENTS       24   //  Minimum number of segments in a complete circle
